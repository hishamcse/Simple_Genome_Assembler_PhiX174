...
/* the number of removed edges during the tip removal in the de Bruijn graph
   constructed from the k-mers occurring in error-prone reads from the mutated phi X174 genome. */
