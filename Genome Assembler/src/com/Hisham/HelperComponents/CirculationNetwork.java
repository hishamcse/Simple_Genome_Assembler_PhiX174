...
/* finding the circulation in a network can be formulated as finding infer multiplicities
   of all edges in the de Bruijn graph of all K-mers from the mutated phi X174 genome. */
