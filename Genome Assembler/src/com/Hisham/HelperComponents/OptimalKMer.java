...
/* Given long error-free reads from the phi X174 genome, there is a choice of values of k for
   breaking these reads into k-mers and further constructing the de Bruijn graph on k-mers
   from reads. find that “optimal” values of k that result in a de Bruijn graph represented by a single cycle */
