...
/* Assembling phi X174 genome from error-free reads.this implementation uses an
   error-prone(that means the reads are consisting of errors)dataset to assemble
   genomes using overlap graph */

public class PhiX174ErrorProneAssembler {
